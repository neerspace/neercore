...
[Obsolete("User NeerCore.DependencyInjection.ServiceAttribute instead of this.")]
public class InjectAttribute : ServiceAttribute
{
	/// <summary>Specifies a DI scope lifetime. </summary>
	public new ServiceLifetime Lifetime { get; set; } = ServiceLifetime.Transient;

	/// <summary>Specify injection type.</summary>
	public new InjectionType InjectionType { get; set; } = InjectionType.Auto;
}

/// <summary>Attribute to simple reference your service class with DI.</summary>
...
public class ServiceAttribute : Attribute
{
	...
	/// <summary>Manually specifies injection type for current implementation.</summary>
