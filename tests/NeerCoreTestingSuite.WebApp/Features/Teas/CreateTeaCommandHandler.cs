...
public class CreateTeaCommandHandler : ICommandHandler<CreateTeaCommand, Tea>
{
	private readonly TeasService _teasService;
	public CreateTeaCommandHandler(TeasService teasService) => _teasService = teasService;
